...
SETTING_DEFINITIONS = [
    ...
    SettingDefinition(
        "automation.lane_conflict_resolver_interval_hours",
        "Lane conflict resolver interval",
        "Safety controls",
        "number",
        6,
        "How often the scheduler queues the DB-first worker that prevents AUTO campaign keyword and URL lane competition.",
    ),
    SettingDefinition(
        "automation.lane_conflict_resolver_max_accounts",
        "Lane conflict resolver accounts",
        "Safety controls",
        "number",
        100,
        "Maximum enabled Google Ads accounts checked per lane conflict resolver run.",
    ),
    SettingDefinition(
        "automation.lane_conflict_resolver_max_drafts",
        "Lane conflict resolver drafts",
        "Safety controls",
        "number",
        200,
        "Maximum active automation drafts read per account by the lane conflict resolver. This worker uses DB draft intent and does not query Google directly.",
    ),
    SettingDefinition(
    ...
    SettingDefinition(
        "automation.roas_impression_maintenance_enabled",
        "ROAS impression maintenance worker",
        "Automation",
        "checkbox",
        True,
        "Runs the dedicated AUTO campaign impression/ROAS rescue worker for non-red-flagged accounts.",
    ),
    SettingDefinition(
        "automation.roas_impression_maintenance_interval_hours",
        "ROAS impression maintenance interval",
        "Automation",
        "number",
        24,
        "How often to queue the campaign-level no-impression rescue and recovery worker.",
    ),
    SettingDefinition(
        "automation.roas_impression_maintenance_max_accounts",
        "ROAS impression accounts per run",
        "Automation",
        "number",
        100,
        "Maximum Google Ads accounts processed by one ROAS impression maintenance run.",
    ),
    SettingDefinition(
