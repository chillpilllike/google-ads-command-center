...
SETTING_DEFINITIONS = [
    ...
    SettingDefinition(
        "autopilot.maximize_clicks_after_hours",
        "Maximize Clicks after hours",
        "Autopilot Max Clicks",
        "number",
        24,
        "Hours with no impressions before Search campaigns are moved to Maximize Clicks rescue.",
    ),
    SettingDefinition(
        "autopilot.maximize_clicks_cpc_inr",
        "INR max CPC bid limit",
        "Autopilot Max Clicks",
        "number",
        300,
        "Initial Maximize Clicks maximum CPC bid limit for INR campaigns.",
    ),
    SettingDefinition(
        "autopilot.maximize_clicks_cpc_aud",
        "AUD max CPC bid limit",
        "Autopilot Max Clicks",
        "number",
        20,
        "Initial Maximize Clicks maximum CPC bid limit for AUD campaigns.",
    ),
    SettingDefinition(
        "autopilot.cpc_step_inr",
        "INR CPC increase step",
        "Autopilot Max Clicks",
        "number",
        200,
        "Amount added to INR max CPC after each retry interval while impressions remain absent.",
    ),
    SettingDefinition(
        "autopilot.cpc_step_aud",
        "AUD CPC increase step",
        "Autopilot Max Clicks",
        "number",
        10,
        "Amount added to AUD max CPC after each retry interval while impressions remain absent.",
    ),
    SettingDefinition(
        "autopilot.cpc_increase_interval_hours",
        "CPC increase interval hours",
        "Autopilot Max Clicks",
        "number",
        6,
        "How often to raise the Maximize Clicks CPC cap while a rescue campaign still has no impressions.",
    ),
    SettingDefinition(
