...
DEFAULT_STRATEGIES = [
    ...
    },
    {
        ...
        "mode": "autopilot",
        "description": "Postgres-audited autopilot for purchase-goal alignment, no-impression budget unlocks, Target ROAS lowering, and Search Maximize Clicks rescue.",
        "details": {
            ...
            "covers": [
                ...
                "Search campaign Maximize Clicks rescue with a maximum CPC bid limit.",
            ...
            "mechanism": [
                ...
                "After the configured wait, moves Search campaigns to Maximize Clicks with an initial CPC cap.",
                "Raises the CPC cap after each configured retry interval while impressions remain absent.",
                "After the configured no-impression window, removes Target ROAS and CPC caps where the API allows it, then observes every configured interval.",
                "When impressions return and controlled spend reaches the restore threshold, returns regular Target ROAS and initial CPC caps.",
            ...
            "safety": [
                ...
                "Does not create Maximize Clicks rescue for Performance Max because Google Ads API does not support that bidding strategy for PMax.",
            ...
            "settings": [
                ...
                "autopilot.maximize_clicks_after_hours, CPC bid limits, CPC steps, and disable_after_hours control Maximize Clicks rescue.",
